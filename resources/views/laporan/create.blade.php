    ...
    <div class="bg-[rgb(255,232,157)]  p-6 rounded-xl shadow-sm border border-slate-100">
        <form action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea name="deskripsi_kerusakan" rows="3" required placeholder="Jelaskan kerusakannya..." class="w-full px-3 py-2 border rounded-lg text-sm bg-[rgb(255,247,222)]"></textarea>
            </div>
