...
<div class="space-y-6">
    ...
    <div class="bg-[rgb(255,232,157)] p-6 rounded-2xl shadow-sm border border-amber-400/80">
        <div class="flex items-center justify-between mb-4">
            <div>
                <h3 class="text-lg font-bold text-stone-800">Aktivitas & Pembaruan Status</h3>
                <p class="text-stone-700 text-sm mt-0.5">Riwayat perubahan status terbaru dari laporan fasilitas yang kamu ajukan.</p>
            </div>
        ...
        <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-stone-900">
                                Laporan untuk <span class="text-amber-900 underline">{{ $activity->laporan->barang->nama_barang ?? 'Fasilitas Kantor' }}</span>
                            </p>
            ...
            @empty
                <div class="text-center py-6 bg-white/40 rounded-xl border border-dashed border-amber-300">
                    <p class="text-stone-600 text-sm">Belum ada pembaruan status laporan saat ini.</p>
                </div>
            @endforelse
        </div>
    </div>
